    ...
    def _handle_exception(cls, exception):
        ...
        if not is_website_request:
            ...
            try:
                ...
                # TODO: exception.qweb does not exist -> This except occurs in dev mod if exception is not qweb or qweb without a cause
                ...
                if code == 500:
                    ...
                    if 'qweb_exception' in values:
                        ...
                        values['views'] = values['views'].filtered(
                            lambda view: view._get_xml_view().arch_fs or 'oe_structure' in view.key
                        )
                elif code == 403:
