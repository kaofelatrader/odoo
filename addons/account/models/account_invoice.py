...
class AccountInvoice(models.Model):
    ...
    def message_new(self, msg_dict, custom_values=None):
        ...
        partner_id = self.env['mail.thread'].sudo()._mail_search_on_partner(email_from, extra_domain=[('supplier', '=', True)]).id
        ...
        if not partner_id:
            user_partner_id = self.env['mail.thread'].sudo()._mail_search_on_user(email_from).id
