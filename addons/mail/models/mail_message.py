...
class Message(models.Model):
    ...
    def _message_read_dict_postprocess(self, messages, message_tree):
        ...
        # 3. Tracking values
        tracking_values = self.env['mail.tracking.value'].sudo().search(['&', ('mail_message_id', 'in', message_ids), '|', ('company_id', '=', False), ('company_id', 'child_of', self.env.user.company_id.ids)])
