...
class MassMailController(MassMailController):
    ...
    def subscribe(self, list_id, email, **post):
        ...
        mass_mailing_popup = request.env['mail.mass_mailing.list'].sudo().search([('id', '=', list_id)], limit=1)
        return {'toast_content': mass_mailing_popup.toast_content}
    ...
    def get_mass_mailing_content(self, newsletter_id, **post):
        PopupModel = request.env['mail.mass_mailing.popup'].sudo()
