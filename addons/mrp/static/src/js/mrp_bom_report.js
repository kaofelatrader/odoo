...
var MrpBomReport = stock_report_generic.extend({
    ...
    _onClickPrint: function (ev) {
        ...
        framework.blockUI();
        var reportname = 'mrp.report_bom_structure?docids=' + this.given_context.active_id + '&report_name=' + this.given_context.report_name + '&quantity=' + (this.given_context.searchQty || 1);
