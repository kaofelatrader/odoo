...
class Picking(models.Model):
    ...
    def button_validate(self):
        ...
        no_quantities_done = all(float_is_zero(move_line.qty_done, precision_digits=move_line.product_uom_id.decimal_places) for move_line in self.move_line_ids.filtered(lambda m: m.state not in ('done', 'cancel')))
