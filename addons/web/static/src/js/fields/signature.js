...
var FieldBinarySignature = AbstractFieldBinary.extend({
    ...
    _onClickSignature: function () {
        ...
        if (this.mode === 'edit') {
            ...
            if (this.nodeOptions.full_name && this.fields[this.nodeOptions.full_name]) {
                var signName;
                if (this.fields[this.nodeOptions.full_name].type === 'many2one' && this.recordData[this.nodeOptions.full_name]) {
                    signName = this.recordData[this.nodeOptions.full_name].data.display_name || '';
                } else {
