...
class HrHolidaysEmployeeMixin(models.AbstractModel):
    _name = "hr.holidays.employee.mixin"
    _description = 'Holidays Employee Mixin'
    ...
    def _onchange_parent_id(self):
        super(HrHolidaysEmployeeMixin, self)._onchange_parent_id()
    ...
    def write(self, values):
        res = super(HrHolidaysEmployeeMixin, self).write(values)
...
class HrEmployeePrivate(models.Model):
    _name = 'hr.employee'
    _inherit = ['hr.employee', 'hr.holidays.employee.mixin']


class HrEmployeePublic(models.Model):
    _name = 'hr.employee.public'
    _inherit = ['hr.employee.public', 'hr.holidays.employee.mixin']
