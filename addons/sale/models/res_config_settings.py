...
class ResConfigSettings(models.TransientModel):
    ...
    group_confirmation_pay = fields.Boolean(related='company_id.group_confirmation_pay', string='Online Payment', readonly=False, implied_group='sale.group_confirmation_pay')
    ...
    @api.onchange('group_confirmation_pay')
    def _onchange_group_confirmation_pay(self):
        if self.group_confirmation_pay:
