...
.. TODO is it still True? No use in Odoo codebase, not found anywhere.
...
.. note:: it will also yield the various :ref:`automatic fields
          <reference/orm/records/attributes>` unless they've been disabled
